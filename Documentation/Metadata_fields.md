...
| [asset_locked](Metadata_field_descriptions/asset_locked.md) | ARS | An asset has been synced with ERDA and is set to be published to specify. | Integration / ARS | When condition have been met in ARS | - |
...
| [camera_setting_control](Metadata_field_descriptions/camera_setting_control.md) | TBD | | | | |
...
| [complete_digitiser_list](Metadata_field_descriptions/compltete_digitiser_list.md) | TBD | | | | |
| [date_asset_created_ars](Metadata_field_descriptions/date_asset_created_ars.md) | ARS | Upon event | ARS | Upon ARS call | Stamp for creation with ARS |
| [date_asset_deleted_ars](Metadata_field_descriptions/date_asset_deleted_ars.md) | ARS | Event based | ARS | Event based | |
...
| [date_audited](Metadata_field_descriptions/date_audited.md) | TBD | | | | |
| [date_metadata_created_ars](Metadata_field_descriptions/date_metadata_created_ars.md) | Ingestion client | Running IngestionClient | Metadata file / Integration / ARS | Upon creation / Upon integration creation / Upon ARS call | |
| [date_metadata_ingested](Metadata_field_descriptions/date_metadata_ingested.md) | TBD | | | | |
| [date_metadata_updated_ars](Metadata_field_descriptions/date_metadata_updated_ars.md) | ARS | Event based | ARS | Event completion | |
| [date_pushed_to_specify](Metadata_field_descriptions/date_pushed_to_specify.md) | TBD | | | | |
...
| [external_publishers](Metadata_field_descriptions/external_publishers.md) | TBD | | | | |
...
| [push_to_specify](Metadata_field_descriptions/push_to_specify.md) | ARS | Event | ARS | Event | |
| [restricted_access](Metadata_field_descriptions/restricted_access.md) | TBD | | | | |
| [session_id](Metadata_field_descriptions/session_id.md) | TBD | | | | |
| [specify_attachment_remarks](Metadata_field_descriptions/specify_attachment_remarks.md) | TBD | | | | |
| [specify_attachment_title](Metadata_field_descriptions/specify_attachment_title.md) | TBD | | | | |
