| Process | "jobs_status" | "files_status" | "asset_size" | "hpc_ready" | "is_in_ars" | "has_new_file" | "has_open_share" | "erda_sync" | "update_metadata" | "asset_type" | "temporary_files_ndrive" | "temporary_files_local" | "available_for_services" | "metadata_origin" | "temporary_tusd_id" |
|-------------|--------|------|------|------|------|------|------|-----|------|------|------|------|------|------|------|
...
| IngestionInterface\ING_receive_metadata | -> WAITING | -> NONE | -> size | ->NO | -> AWAIT -> NO | -> YES | -> NO | -> NO | -> NO | -> UNKNOWN | - | - | -> YES | -> INGESTION_QUEUE | tusd file id |
| IngestionInterface\ING_synced_ERDA_publisher | - | - | - | - | - | - | - | YES | - | - | - | - | YES | INGESTION_QUEUE | Exists -> remove field |

| P | js | fs | a s | ready | ars | n file | open sha | e sync | upd mdata | asset type | temp f N | temp file l | available | metadata origin | temp tusd id |
