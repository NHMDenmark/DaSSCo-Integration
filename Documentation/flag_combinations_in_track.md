...
| HpcApi\hpc_api barcode | -> relevant status | - | - | - | - | - | - | - | - | -> YES | -> YES | UNKNOWN -> type status | - | - | - | - | - |
| HpcApi\hpc_api derivative | -> DONE | -> NONE | -> parent size + estimate size | -> YES | -> AWAIT -> NO | -> NO | -> NO | -> NO | -> NO | -> NO | -> NO | - | - | - | - | - | - |
...
| HealthUtility\flag_paused_status_handler | - | - | - | (PAUSED) -> previous | (PAUSED) -> previous | (PAUSED) -> previous | (PAUSED) -> previous | (PAUSED) -> previous | (PAUSED) -> previous | (PAUSED) -> previous | - | - | - | - | - | - | - |
| HealthUtility\hpc_job_retry_handler | RETRY -> WAITING | - | - | - | - | - | - | - | - | - | - | - | - | - | - |
| HealthUtility\asset_error_status_handler | (ERROR) -> ? | (ERROR) -> ? | - | (ERROR) -> ? | (ERROR) -> ? | (ERROR) -> ? | (ERROR) -> ? | (ERROR) -> ? | (ERROR) -> ? | (ERROR) -> ? | - | - | (ERROR) -> ? | (ERROR) -> ? | (ERROR) -> ? | - | - |
| IngestionInterface\ING_ARS_uploaded_listener | - | - | - | - | - | -> AWAIT | - | - | - | - | - | - | - | - | - | - |
| IngestionInterface\ING_publisher_ARS_link | WAITING | - | - | - | - | YES -> UPLOADING | YES | - | - | - | - | - | - | - | YES | INGESTION_QUEUE | Exists |
| IngestionInterface\ING_receive_metadata | -> WAITING | -> NONE | -> size | ->NO | -> AWAIT -> NO | -> YES | -> NO | -> NO | -> NO | -> NO | -> NO/YES | -> UNKNOWN | - | - | -> YES | -> INGESTION_QUEUE | tusd file id |
| IngestionInterface\ING_synced_ERDA_publisher | - | - | - | - | - | - | - | YES | - | - | - | - | - | - | YES | INGESTION_QUEUE | Exists -> remove field |

| P | js | fs | a s | ready | ars | n file | open sha | e sync | spec sync | upd mdata | asset type | temp f N | temp file l | available | metadata origin | temp tusd id |

empty doesnt concern this service   
(status) is when its a possibility for triggering
Exists means this field is required
