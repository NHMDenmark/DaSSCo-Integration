| Process | "jobs_status" | "files_status" | "asset_size" | "hpc_ready" | "is_in_ars" | "has_new_file" | "has_open_share" | "erda_sync" | "specify_sync" | "update_metadata" | "asset_type" | "temporary_files_ndrive" | "temporary_files_local" | "available_for_services" | "metadata_origin" | "temporary_tusd_id" |
|-------------|--------|------|------|------|------|------|------|-----|------|------|------|------|-----|-----|------|------|
| Ndrive\process_new_files_from_ndrive | -> WAITING | -> NONE | -> file size | -> NO | -> AWAIT -> NO | -> YES | -> NO | -> NO | -> NO | -> NO | -> UNKNOWN | -> YES | -> YES | -> YES | - | - |
...
| IngestionInterface\ING_receive_metadata | -> WAITING | -> NONE | -> size | ->NO | -> AWAIT -> NO | -> YES | -> NO | -> NO | -> NO | -> NO | -> UNKNOWN | - | - | -> YES | -> INGESTION_QUEUE | tusd file id |
