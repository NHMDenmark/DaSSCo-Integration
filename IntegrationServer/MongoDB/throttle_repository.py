...
class ThrottleRepository:
    ...
    def reset_throttle(self):
        try:
            self.all.update_entry("assets_in_flight", "value", 0)
            self.all.update_entry("await_sync_asset_count", "value", 0)
            self.all.update_entry("total_asset_size_mb", "value", 0)
            self.all.update_entry("total_new_asset_size_mb", "value", 0)
            self.all.update_entry("total_derivative_size_mb", "value", 0)
