...
echo "export PATH=/home/dassco/mongodb/mongodb-linux-x86_64-ubuntu2204-7.0.6/bin:\$PATH" >> $HOMEPATH/.bashrc
echo "export PATH=/home/dassco/mongo-install/mongosh-2.1.5-linux-x64/bin:\$PATH" >> $HOMEPATH/.bashrc
