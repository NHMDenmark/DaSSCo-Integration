...
class SpecifyOpenShare(Status, Validate):
    ...
    def __init__(self):
        ...
        self.service_name = "Specify open share ARS"
        self.prefix_id = "SosA"
    ...
    def loop(self):
        ...
        while self.run == self.status_enum.RUNNING.value:
            ...
            asset = self.mongo_track.get_entry_from_multiple_key_pairs([{"has_open_share": self.NO, "jobs_status": self.DONE, "is_in_ars": self.YES, "specify_sync": self.validate_enum.PREPARE.value,
