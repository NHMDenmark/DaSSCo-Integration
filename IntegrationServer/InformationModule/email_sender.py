...
class EmailSender:
    ...
    def __init__(self, mail):
        ...
        try:
            ...
            raise ValueError(f"Failed to load email recipient/sender configuration from environment variables. Check if the .env file is properly configured. Error: {e}")
